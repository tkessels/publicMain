...
public class DragableJTabbedPane extends JTabbedPane {
	...
	public DragableJTabbedPane() {
		...
		m_acceptor = new TabAcceptor() {
			public boolean isDropAcceptable(DragableJTabbedPane a_component, int a_index) {
				return true;
			}
		};
	}
	...
	class TabTransferable implements Transferable {
		...
		public TabTransferable(DragableJTabbedPane a_tabbedPane, int a_tabIndex) {
			m_data = new TabTransferData(DragableJTabbedPane.this, a_tabIndex);
		}
	...
	class TabTransferData {
		private DragableJTabbedPane m_tabbedPane = null;
		private int m_tabIndex = -1;

		public TabTransferData() {
		}

		public TabTransferData(DragableJTabbedPane a_tabbedPane, int a_tabIndex) {
			m_tabbedPane = a_tabbedPane;
			m_tabIndex = a_tabIndex;
		}

		public DragableJTabbedPane getTabbedPane() {
			return m_tabbedPane;
		}

		public void setTabbedPane(DragableJTabbedPane pane) {
			m_tabbedPane = pane;
		}
	...
	private Point buildGhostLocation(Point a_location) {
		...
		retval = SwingUtilities.convertPoint(DragableJTabbedPane.this,
				retval, s_glassPane);
		return retval;
	}
	...
	class CDropTargetListener implements DropTargetListener {
		...
		public boolean isDragAcceptable(DropTargetDragEvent e) {
			...
			if (DragableJTabbedPane.this == data.getTabbedPane()
					&& data.getTabIndex() >= 0) {
				return true;
			} // if
	...
	private void convertTab(TabTransferData a_data, int a_targetIndex) {
        ...
        DragableJTabbedPane source = a_data.getTabbedPane();
//        System.out.println("this=source? " + (this == source));
	...
	public interface TabAcceptor {
		boolean isDropAcceptable(DragableJTabbedPane a_component, int a_index);
	}
}
