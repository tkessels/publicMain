 ...
 * 
 * Diese Klasse stellt das AbstractListModel für die Gruppenliste zur Verfügung.
 * 
 * @author ATRM
 * 
 */
public class GroupListModel extends AbstractListModel<String> {
	 ...
	 * 
	 * Der Konstruktor für das GroupListModel startet einen Thread welcher den
	 * Inhalt der Liste aktuell halten soll und somit nur aktuell existierende
	 * Gruppen anzeigt.
	 */
	 ...
	 * 
	 * Diese Methode prüft ob ein übergebener String (group) bereits in der
	 * Liste (groups) enthalten ist. Ist dies der Fall wird true zurückgegeben
